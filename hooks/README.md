...
that line counts characters the hook can see; at the next request a
`context 599k -> 210k tokens (...)` line gives the real before and after, read
from the API's usage. The
